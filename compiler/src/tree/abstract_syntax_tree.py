...
from src.exceptions import LogicError, ImmutableError
...
class CallFunction(BaseBox):
    ...
    def eval(self, node, builder=None):
        ...
        res = builder.call(functions[self.name], args_eval)
        return res
...
class Sumi(BaseFunction):
    ...
    def eval(self, node, builder=None):
        ...
        res = builder.call(functions['sum'], (self.value, self.value2))
        return res
...
class Sumf(BaseFunction):
    ...
    def eval(self, node, builder=None):
        ...
        res = builder.call(functions['sumf'], (self.value, self.value2))
        return res
...
class Subi(BaseFunction):
    ...
    def eval(self, node, builder=None):
        ...
        res = builder.call(functions['sub'], (self.value, self.value2))
        return res
...
class Subf(BaseFunction):
    ...
    def eval(self, node, builder=None):
        ...
        res = builder.call(functions['subf'], (self.value, self.value2))
        return res
